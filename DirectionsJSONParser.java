...
public class DirectionsJSONParser {
    ...
    /*public String getDistance(JSONObject jObject) {
        ...
        try {
            res = jObject.get("distance").toString();
        }
        catch(Exception e) {
            e.printStackTrace();
        }
    ...
    public List<String> getData(JSONObject jObject) {
        ...
        try {
            ...
            for (int i = 0; i < jRoutes.length(); i++) {
                ...
                for (int j = 0; j < jLegs.length(); j++) {
                    ...
                    data.add(jDistance.get("text").toString());
                    data.add(jDuration.get("text").toString());
                }
            }
